...
class Ui_Vizitown(object):
    def setupUi(self, Vizitown):
        ...
        self.layerSelectionWidget = QtGui.QTableWidget(self.groupBox_3)
        self.layerSelectionWidget.setAlternatingRowColors(True)
        self.layerSelectionWidget.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
        self.layerSelectionWidget.setColumnCount(3)
        self.layerSelectionWidget.setObjectName(_fromUtf8("layerSelectionWidget"))
        self.layerSelectionWidget.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        self.layerSelectionWidget.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.layerSelectionWidget.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.layerSelectionWidget.setHorizontalHeaderItem(2, item)
        self.layerSelectionWidget.horizontalHeader().setStretchLastSection(True)
        self.verticalLayout.addWidget(self.layerSelectionWidget)
        ...
        self.gridLayout.addWidget(self.cb_tuile, 0, 1, 1, 1)
        ...
        self.verticalLayout_3.addWidget(self.btn_defaut)
    ...
    def retranslateUi(self, Vizitown):
        ...
        self.layerSelectionWidget.setSortingEnabled(True)
        item = self.layerSelectionWidget.horizontalHeaderItem(0)
        item.setText(_translate("Vizitown", "Display", None))
        item = self.layerSelectionWidget.horizontalHeaderItem(1)
        item.setText(_translate("Vizitown", "Layer", None))
        item = self.layerSelectionWidget.horizontalHeaderItem(2)
